...
const DashboardHeader = () => {
  ...
  return (
    <div className="fixed top-10 left-0 right-0 z-20 w-full bg-[rgb(37,38,45)] text-white border-t border-t-[rgb(101,101,101)] px-4 py-0.5">
      {/* Mobile-only row */}
        ...
        <div className="flex items-center gap-3">
          <div className="relative">
            ...
            <input
              ...
              className="border border-gray-300 bg-[rgb(86,87,93)] text-[rgb(222,222,226)] pl-7 pr-2 py-0.5 rounded outline-none text-sm w-40 lg:w-56"
            />
          </div>
